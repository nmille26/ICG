...
import mesa
#we've created these agents in agents_ICG.py
...
class SugarscapeCg(mesa.Model):
    ...
    verbose = True  # Print-monitoring, still don't understand verbosity fully
    ...
    def __init__(self, width=50, height=50, initial_population=100):
        ...
        # Set parameters
        ## What is a torus? Is this a feature within grid to add 3 dimensions and allow for a map to 'wrap'?
        self.width = width
        self.height = height
        ...
        # Create sugar
        ## numpy is for 'high level math.' Whatevs. 
        import numpy as np
